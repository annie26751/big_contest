...
DTW_LABELS = {
    ...
    "0": {
        ...
        "key_industries": "커피전문점, 카페, 베이커리 등 트렌드와 SNS 바이럴에 가장 민감한 업종이 압도적으로 많습니다.",
    },
    # 💎 압도적인 초우량 그룹 (User's Cluster 0)
    "1": {
        "name": '압도적인 초우량 그룹 ("시장 지배자")',
        "tone": "info",
        "icon": "💎",
        "intro": "DTW 기반 패턴분석 결과입니다.",
        "pattern": [
        ...
        "interpretation": (
            ...
            "이 그룹은 특정 업종이나 고객층에 의존하지 않습니다. 이미 '상권을 대표하는 랜드마크' 또는 '대체 불가능한 브랜드'로 자리 잡아, "
            "모든 유형의 고객(거주/직장/유동)과 모든 연령층을 끌어모읍니다. 이미 경쟁의 단계를 초월하여 시장 자체를 지배하고 있는 그룹입니다."
        ),
        "key_industries": "커피전문점, 한식-단품요리일반, 포장마차, 청과물 등 업종을 가리지 않고 다양한 분야의 1등 상점들이 포진해 있습니다.",
    },
    ...
    "2": {
        ...
        "interpretation": (
            ...
            "이 그룹은 '어떻게' 실패했는지를 보여줍니다. Cluster 3과 같은 커피/카페 업종임에도 불구하고, (1) 트렌드를 주도하는 30대 여성 핵심 고객을 빼앗기고, "
            "(2) 배달과 같은 디지털 전환에 대응하지 못했으며, (3) Cluster 1처럼 확실한 지역 단골을 확보하지도 못하면서 양쪽 모두에게서 경쟁력을 잃고 쇠퇴하고 있습니다."
        ),
        "key_industries": "커피전문점, 카페, 한식-단품요리일반이 많습니다. 이는 고성장 그룹(Cluster 3)과 업종이 겹친다는 점이 핵심입니다.",
    },
    ...
    "3": {
        ...
        "key_industries": "한식-단품요리일반, 요리주점, 한식-육류/고기 등 지역 기반의 전통적인 외식업이 주를 이룹니다.",
    },
}
